    ...
    <div class="row">
        <div class="col">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <th scope="row">Nom</th>
                    <td><input class="form-control" type="text" name="nom" value="<?php echo set_value('nom'); ?>"/>
                    </td>
                </tr>
                <tr>
                    <th scope="row">Marque</th>
                    <td><input class="form-control" type="text" name="marque" list="liste_marque"
                               value="<?php echo set_value('marque'); ?>"/></td>
                </tr>
                <tr>
                    <th scope="row">Pays</th>
                    <td>
                        <button type="button" class="btn btn-success mb-2" onclick="ajouterInputPays()">Ajouter un
                            pays
                        </button>
                        <div id="pays">
                        </div>
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="portion"
                               value="<?php echo set_value('portion'); ?>"/></td>
                </tr>
                </tbody>
            </table>
            ...
            <h1>Composition</h1>
            <h2>Additifs</h2>
            <button type="button" class="btn btn-success mb-2" onclick="ajouterInputAdditif()">Ajouter un additif
            </button>
            <div id="additifs">
            </div>
            <h2>Ingrédients</h2>
            <button type="button" class="btn btn-success mb-2" onclick="ajouterIngredient('')">Ajouter un ingrédient
            </button>
        ...
        <div class="col">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="number" name="energie"
                               value="<?php echo set_value('energie'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Graisse</th>
                    <td><input class="form-control" type="number" name="matieresGrasses"
                               value="<?php echo set_value('matieresGrasses'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Graisse saturées</th>
                    <td><input class="form-control" type="number" name="matieresGrassesSaturees"
                               value="<?php echo set_value('matieresGrassesSaturees'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Graisse transformées</th>
                    <td><input class="form-control" type="number" name="matieresGrassesTransformees"
                               value="<?php echo set_value('matieresGrassesTransformees'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Choléstérol</th>
                    <td><input class="form-control" type="number" name="cholesterol"
                               value="<?php echo set_value('cholesterol'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Carbohydrates</th>
                    <td><input class="form-control" type="number" name="carbo"
                               value="<?php echo set_value('carbo'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Sucres</th>
                    <td><input class="form-control" type="number" name="sucres"
                               value="<?php echo set_value('sucres'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Fibres</th>
                    <td><input class="form-control" type="number" name="fibresAlimentaires"
                               value="<?php echo set_value('fibresAlimentaires'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Protéines</th>
                    <td><input class="form-control" type="number" name="proteines"
                               value="<?php echo set_value('proteines'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Sel</th>
                    <td><input class="form-control" type="number" name="sel"
                               value="<?php echo set_value('sel'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Sodium</th>
                    <td><input class="form-control" type="number" name="sodium"
                               value="<?php echo set_value('sodium'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Vitamine A</th>
                    <td><input class="form-control" type="number" name="vitamineA"
                               value="<?php echo set_value('vitamineA'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Vitamine C</th>
                    <td><input class="form-control" type="number" name="vitamineC"
                               value="<?php echo set_value('vitamineC'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Calcium</th>
                    <td><input class="form-control" type="number" name="calcium"
                               value="<?php echo set_value('calcium'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Fer</th>
                    <td><input class="form-control" type="number" name="fer"
                               value="<?php echo set_value('fer'); ?>"></input></td>
                </tr>
                <tr>
                    <th scope="row">Score nutritif</th>
                    <td><input class="form-control" type="number" name="scoreNutritif"
                               value="<?php echo set_value('scoreNutritif'); ?>"></input></td>
                </tr>
                </tbody>
            </table>
        </div>
